...
export default function SignupContent() {
  ...
  // Update the handleSubmit function to properly show the loading screen and check status
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (verifyData.user && verifyData.user._id) {
        ...
        // Use the userId from state if available
  ...
  // Add the missing checkDataLoadingStatus function after the handleResendCode function
  ...
  // Add the data loading screen to the component's return statement
  // Replace the entire return statement with this updated version that includes the data loading screen
  return (
        ...
        <>
          <div className="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <p className="mt-2 text-center text-sm text-gray-600">
              Track grocery prices and save money on your shopping
            </p>
          </div>
